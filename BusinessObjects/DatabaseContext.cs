...
public partial class DatabaseContext : DbContext {
  ...
  private string GetConnectionString() {
    ...
    //string c = File.ReadAllText(path, System.Text.Encoding.UTF8);
    //Console.WriteLine(c);
  ...
  protected override void OnModelCreating(ModelBuilder modelBuilder) {
    modelBuilder.Entity<AccountMember>(entity => {
      entity.HasKey(e => e.MemberId).HasName("PK__AccountM__0CF04B38D4C06C1E");
    ...
    modelBuilder.Entity<Category>(entity => {
      entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2BCD3318E8");
    ...
    modelBuilder.Entity<Product>(entity => {
      entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6ED3E27728F");
